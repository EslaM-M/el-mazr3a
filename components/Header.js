...
function Header() {
  ...
  return (
    <header className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top && 'bg-white blur shadow-lg'}`}>
      <div className="max-w-full mx-96  px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <a href="/signup" className="btn-sm text-green-500 bg-gray-100 hover:bg-gray-200 ml-3">
                  <span>Start Now</span>
                  <svg className="w-3 h-3 fill-current text-green-400 flex-shrink-0 ml-2 -mr-1" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
